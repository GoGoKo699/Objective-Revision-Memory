...
\qquad C_\varepsilon=\frac{a\eta}{2}+\ln\cosh a.\tag{3}$$
...
\qquad
\limsup_n\frac Bn
\le\frac1L\sum_{\ell=1}^L[1-h_2(\delta_\ell)].\tag{7}$$
...
At $s=a/n$ this gives
$\log v_n\le-n\mathcal R(\varepsilon)\ln2+O_\varepsilon(1)$.
